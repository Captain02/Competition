...
public class BugController {
	...
	public Msg editor(@Valid ProjectBug projectBug, BindingResult result, MultipartFile file,
	...
	public Msg add(@RequestParam("ccid") String ccid, @Valid ProjectBug projectBug, BindingResult result,
